...
import EventMerchandise from './pages/EventMerchandise';
import RegionalAlumni from './pages/RegionalAlumni';
...
const AppContent = () => {
  ...
  const isComprehensiveForm = location.pathname === '/comprehensive-form';
  const isBulkOrder = location.pathname === '/bulk-order';
  const hideHeaderFooter = isComprehensiveForm || isBulkOrder;
    ...
    <div className="App">
      ...
      <main>
        <Routes>
          ...
          <Route path="/event-merchandise" element={<EventMerchandise />} />
          <Route path="/accessories" element={<Accessories />} />
          <Route path="/alumni-kits" element={<AlumniKits />} />
          <Route path="/regional-alumni" element={<RegionalAlumni />} />
          ...
          <Route path="/comprehensive-form" element={<ComprehensiveForm />} />
        </Routes>
      </main>
      {!hideHeaderFooter && <FooterEnhanced />}
